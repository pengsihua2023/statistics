...
* 常用工具：质量控制图（Control Chart）

📍 **案例**：
工厂在生产线上应用控制图，监控产品重量是否稳定在合格范围内。

<img width="700" height="350" alt="image" src="https://github.com/user-attachments/assets/c4b7e901-1ad6-480b-b1c1-fe45851a3d37" />
  
这张图演示了 工厂生产线的控制图（Control Chart）：  
蓝色折线点：50个样本产品的重量测量值。  
绿色虚线：目标重量（Target Weight）。  
红色虚线：上控制限（UCL）和下控制限（LCL），用于判断产品是否超出合格波动范围。  
红点：超出控制限的异常点（Out of Control），提示生产过程可能存在问题。
